...
- **The most frequently used and free available compiler is GNU C/C++ compiler**, otherwise you can have compilers either from HP or Solaris if you have the respective Operating Systems.
