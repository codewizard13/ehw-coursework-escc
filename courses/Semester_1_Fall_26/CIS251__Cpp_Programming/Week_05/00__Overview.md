...
# CIS 251 - C++ Programming:  <br> Week 5 Overview - Functions, Scope, Decomposition, and Reuse


**Due date:** Sunday, September 20, 2026 at 11:59 PM Central.
...
*   return values
*   separate responsibilities across functions
*   explain variable scope

### 1\. C++ Institute assignment

**C++ Essentials 1 — Module 3: designing/declaring/invoking functions, parameter passing, default parameters, inline functions, and overloaded functions. Focus this week on standard user-defined functions, parameters, return values, and scope.**
...
| Week 5 Programming Assignment | 100 |
| Week 5 Quiz | 20  |
